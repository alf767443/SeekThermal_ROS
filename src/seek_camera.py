...
class ThermalCamera:
    def __init__(self):
        ...
        self.raw_image_publisher = rospy.Publisher("/thermal_camera/image_raw/Image", Image, queue_size=10)
        self.raw_info_publisher = rospy.Publisher("/thermal_camera/image_raw/Info", CameraFrame, queue_size=10)
    ...
    def on_frame(self, _camera, camera_frame, renderer: Renderer):
        ...
        with renderer.frame_condition:
            ...
            self.raw_info_publisher.publish(self.SeekFrame2msg(frameHeader=renderer.frame.header))
